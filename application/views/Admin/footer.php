...
<h5 class="widget-title">AIMTECH<span></span></h5>
<p>We can provide you all web development services.</p>
</div>
</div>
...
<li>
<div class="thumb-content"><a href="//localhost/wordpress">About</a></div> 
</li>
</ul>
</div>
</div>
...
<p>Get register first for post your articles to our website.</p>
<a class="btn" href=<?php echo base_url('index.php/login/registration');?> target="_blank">Register Now</a>
</div>
</div>
...
<p><a href="mailto:info@domain.com" title="glorythemes">omkarchoudhary2012@gmail.com</a></p>
...
<p>Copyright AIMTECH © 2021. All rights reserved.</p>
</div>
</div>
</div>
</div>
